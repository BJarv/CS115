...
public class FirstPersonNetworkKrab : Photon.MonoBehaviour
{
    FirstPersonCameraNET cameraScript;
    FirstPersonControllerNET controllerScript;
    private bool appliedInitialUpdate;

    void Awake()
    {
		cameraScript = GetComponent<FirstPersonCameraNET>();
		controllerScript = GetComponent<FirstPersonControllerNET>();
